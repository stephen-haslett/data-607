...
ham_term_plot <- ggplot(subset(ham_term_freq, Frequency > 5), aes(x = reorder(Term, - Frequency), y = Frequency)) +
...
spam_term_plot <- ggplot(subset(spam_term_freq, Frequency > 10), aes(x = reorder(Term, - Frequency), y = Frequency)) +
